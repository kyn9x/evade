...
namespace Evade
{
    internal class EvadeSpellDatabase
    {
        ...
        static EvadeSpellDatabase()
        {
            ...
            //Walking.
            spell = new EvadeSpellData("Đi bộ để né", 1);
            Spells.Add(spell);
            ...
            {
                spell = new BlinkData("Tốc biến", ObjectManager.Player.GetSpellSlotFromName("summonerflash"), 400, 100, 5,
                    true);
                Spells.Add(spell);
            }

            //Zhonyas
            spell = new EvadeSpellData("Đồng hồ cát", 5);
            Spells.Add(spell);
