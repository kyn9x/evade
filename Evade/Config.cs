...
namespace Evade
{
    internal static class Config
    {
        ...
        public const int CrossingTimeOffset = 400;

        public const int EvadingFirstTimeOffset = 400;
        public const int EvadingSecondTimeOffset = 230;

        public const int EvadingRouteChangeTimeOffset = 400;
